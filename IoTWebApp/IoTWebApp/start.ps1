...
python aws-iot-device-sdk-python\samples\basicPubSub\basicPubSub.py -e a2mg9vfb20i9t7-ats.iot.eu-west-1.amazonaws.com -r root-CA.crt -c CA4017-IoT-WebApp-Thing.cert.pem -k CA4017-IoT-WebApp-Thing.private.key
